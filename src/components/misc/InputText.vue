<template>
    <div class="input-text">
        ...
        <div class="text-left">
            <input
                type="text"
                class="border-2 border-gray-300 ym-disable-keys text-sm py-1 px-2 rounded bg-gray-700"
                :class="{error}"
                ref="input"
                :id="id"
                :value="value"
            ...
            <div class="suggestions suggestions-action cursor-pointer flex flex-wrap justify-center mt-1" v-if="suggestions && suggestions.length">
